Yet another CycleGAN implementation, carefully written by inspecting the [original code](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix) by [junyanz](https://github.com/junyanz).
